        ...
        <div class="background__page">
            <div class="container">
                <div class="block_box" style="margin: 150px auto 75px">
                    ...
                    <div class="col_10">
                        <div class="section">
                            <h2 class="section__title">Независимая оценка качества образования</h2>
                            <div class="menu">
                                <div class="menu__item body_yellow">
                                    <div class="menu__header item__one__row">
                                        ...
                                        <a class="menu__title" target="_blank" href="https://drive.google.com/file/d/1atPDeKTVlGuDUirF6GKrAbGXBbmxHmeT/view?usp=sharing">План по устранению недостатков в ходе проверки НОКО на 2021 год</a>
                                    </div>
                                </div>
                            </div>
                        </div>
