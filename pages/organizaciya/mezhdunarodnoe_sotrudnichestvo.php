        ...
        <div class="background__page">
            <div class="container">
                <div class="block_box" style="margin: 150px auto 75px">
                    ...
                    <div class="col_10">
                        <div class="section">
                            <h2 class="section__title">Международное сотрудничество</h2>
                            <div class="menu">
                                <div class="block__box__text" style="margin: 30px 0px">
                                    <p style="text-align: left;">
                                    Заключенных и планируемых к заключению договорах с иностранными и (или) международными организациями по вопросам образования и науки нет.
                                    </p>
                                </div>
                            </div>
                        </div>
